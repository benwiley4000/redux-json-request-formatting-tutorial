...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxActionTransformMiddleware = __webpack_require__(15);

	var _reduxActionTransformMiddleware2 = _interopRequireDefault(_reduxActionTransformMiddleware);

	var _camelize = __webpack_require__(16);
	...
	var responseMiddleware = function responseMiddleware(store) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			...
			exports["reduxActionTransformMiddleware"] = factory();
		else
			root["reduxActionTransformMiddleware"] = factory();
	})(this, function() {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var _varValidator = __webpack_require__(1);

		var _varValidator2 = _interopRequireDefault(_varValidator);
		...
		var targetTransform = function targetTransform(obj, transformer, targetsRemaining) {
		  if (targetsRemaining.length === 0) {
		    return transformer(obj);
		  }
		  var nextTarget = targetsRemaining[0];
		  var nextObj = obj[nextTarget];

		  var rest = _objectWithoutProperties(obj, [nextTarget]);

		  if (!nextObj) {
		    return obj;
		  }
		  return _extends(_defineProperty({}, nextTarget, targetTransform(nextObj, transformer, targetsRemaining.slice(1))), rest);
		};

		var actionTransformMiddleware = function actionTransformMiddleware(target, transformer, options) {
		  options = options || {};
		  var allowedActions = options.allowedActions;
		  var excludedActions = options.excludedActions;

		  var errors = [];
		  var targetTrail = target.split('.');
		  if (targetTrail.indexOf('') !== -1 || targetTrail.some(function (varName) {
		    return !_varValidator2.default.isValid(varName);
		  })) {
